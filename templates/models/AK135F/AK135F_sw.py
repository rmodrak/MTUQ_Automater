...
from mtuq.event import Origin, UTCDateTime
...
if __name__=='__main__':
    ...
    if comm.rank==0:
        ...
        plot_data_greens1(output_prefix+'FMT_waveforms.png',
            data_sw, greens_sw, process_sw, 
            misfit_sw, stations, origin, best_mt, lune_dict)


        plot_beachball(output_prefix+'FMT_beachball.png',
            best_mt, stations, origin)


        plot_misfit_lune(output_prefix+'FMT_misfit.png', results)


        print('Saving results...\n')

        # save best-fitting source
        save_json(output_prefix+'FMT_solution.json', merged_dict)


        # save misfit surface
        results.save(output_prefix+'FMT_misfit.nc')
